                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($challenge->image)
                                            <img src="{{ asset($challenge->image) }}" alt="challenge image" width="50">
                                        @endif
                                    </td>
                                    ...
                                    {{-- <td class="">
                                        <div class="row ">
                                            ...
                                            <div class="col-md-4 ">
                                                <a class="btn btn-sm btn-warning" href="{{ route('challenge.reports') }}"
                                                    {{ $challenge->id }}>
                                            ...
                                            <div class="col-md-4 ">
                                                <form action="{{ route('Course.destroy', $challenge->id) }}" method="POST"
