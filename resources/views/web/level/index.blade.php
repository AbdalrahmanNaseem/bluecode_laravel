...
@section('contant')
    ...
    <div class="pt-2 pb-4 d-flex align-items-left align-items-md-center flex-column flex-md-row">
        <div>
            ...
            <h6 class="mb-2 op-7">{{ Auth::user()->name }} {{ Auth::user()->FullName }}</h6>
        </div>
    </div>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row card-tools-still-right d-flex justify-content-between align-items-center">
                        <div class="card-title text-light">All Level Info</div>
                                ...
                                @foreach ($levels as $level)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="px-3 py-1 badge fw-bold fs-5 bg-opacity-10 text-primary rounded-pill text-dark">
                                                {{ $level->name }}
                                            </span>
                                        </td>
